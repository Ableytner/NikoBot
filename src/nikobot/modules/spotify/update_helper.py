...
async def run(user_id: int, notify_user: bool = True) -> None:
    ...
    logger.info(f"current: [{current_tracks[0]}, {current_tracks[1]}, {current_tracks[2]}, ..., {current_tracks[-3]}, {current_tracks[-2]}, {current_tracks[-1]}")
    logger.info(f"updated: [{new_tracks[0]}, {new_tracks[1]}, {new_tracks[2]}, ..., {new_tracks[-3]}, {new_tracks[-2]}, {new_tracks[-1]}")
